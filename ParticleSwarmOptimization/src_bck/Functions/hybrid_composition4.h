#ifndef HYBRID_COMPOSITION_4_H
#define HYBRID_COMPOSITION_4_H
...
class HC_4: public Problem{

public:
	HC_4(Configuration* config, int variantID);
	~HC_4();
...
protected:
	...
	long double hybridCompositionFunction4(int dim, const double* x);
	long double noncontinuousHybridCompositionFunction4(int dim, const double* x);
